...
Nova.booting(function (Vue, router) {
    Vue.component('index-external-image', __webpack_require__(3));
    Vue.component('detail-external-image', __webpack_require__(6));
    Vue.component('form-external-image', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _vm.url
    ? _c("img", {
        staticClass: "external-image-thumbnail",
        attrs: { src: _vm.url, width: _vm.width }
      })
    : _c("span", [_vm._v("—")])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c("div", { attrs: { slot: "value" }, slot: "value" }, [
      _vm.url
        ? _c("img", { attrs: { src: _vm.url, width: _vm.width } })
        : _c("span", [_vm._v("—")])
    ])
  ])
}
